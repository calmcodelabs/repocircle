...
> **Status: Phase 1 feature-complete** — groups & invites, repo registry with
> GitHub import, live activity polling with sparklines, asks & stuck flags with
> claims, collaborator requests (real GitHub issues + invitations), Discord
> notifications, personal homepage, PWA with offline support. 58 security-rules
> tests + 30 unit tests in CI. In final testing before the first real group.
